...
public class DesignSettingsCommonBindingImpl extends DesignSettingsCommonBinding {
    ...
    */
    public DesignSettingsCommonBindingImpl(androidx.databinding.DataBindingComponent r11, android.view.View r12) {
        /*
            r10 = this;
            android.util.SparseIntArray r0 = com.tidalab.v2board.clash.design.databinding.DesignSettingsCommonBindingImpl.sViewsWithIds
            r1 = 4
            r2 = 0
            ...
            r11.setTag(r2)
            android.widget.FrameLayout r11 = r10.content
            r11.setTag(r2)
            r11 = 0
            r11 = r0[r11]
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tidalab.v2board.clash.design.databinding.DesignSettingsCommonBindingImpl.<init>(androidx.databinding.DataBindingComponent, android.view.View):void");
    }
    ...
    public void executeBindings() {
        ...
        if (i5 != 0) {
            ...
            f = this.content.getResources().getDimension(R.dimen.toolbar_height) + i4;
        } else {
            i3 = 0;
            i2 = 0;
            i = 0;
        ...
        if (i5 != 0) {
            ...
            AppOpsManagerCompat.setPaddingStart(this.mboundView0, i3);
            AppOpsManagerCompat.setPaddingEnd(this.mboundView0, i);
        }
    }
    ...
    @Override // com.tidalab.v2board.clash.design.databinding.DesignSettingsCommonBinding
