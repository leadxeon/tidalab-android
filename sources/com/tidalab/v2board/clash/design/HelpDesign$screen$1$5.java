...
public final class HelpDesign$screen$1$5 extends Lambda implements Function1<ClickablePreference, Unit> {
    public final /* synthetic */ Context $context;
    public final /* synthetic */ Function1<Uri, Unit> $openLink;

    /* compiled from: HelpDesign.kt */
    /* renamed from: com.tidalab.v2board.clash.design.HelpDesign$screen$1$5$1  reason: invalid class name */
    /* loaded from: classes.dex */
    public final class AnonymousClass1 extends Lambda implements Function0<Unit> {
        ...
        public Unit invoke() {
            this.$openLink.invoke(Uri.parse(this.$context.getString(R.string.donate_url)));
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public HelpDesign$screen$1$5(Function1<? super Uri, Unit> function1, Context context) {
        super(1);
        this.$openLink = function1;
        this.$context = context;
    }
