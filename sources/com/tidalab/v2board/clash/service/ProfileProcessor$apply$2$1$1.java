...
public final class ProfileProcessor$apply$2$1$1 extends Lambda implements Function1<FetchStatus, Unit> {
    public final /* synthetic */ Ref$ObjectRef<IFetchObserver> $cb;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ProfileProcessor$apply$2$1$1(Ref$ObjectRef<IFetchObserver> ref$ObjectRef) {
        super(1);
