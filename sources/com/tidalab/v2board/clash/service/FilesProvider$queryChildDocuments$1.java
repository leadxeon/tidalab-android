...
@DebugMetadata(c = "com.tidalab.v2board.clash.service.FilesProvider$queryChildDocuments$1", f = "FilesProvider.kt", l = {123}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class FilesProvider$queryChildDocuments$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MatrixCursor>, Object> {
    ...
    public FilesProvider$queryChildDocuments$1(String str, FilesProvider filesProvider, String[] strArr, Continuation<? super FilesProvider$queryChildDocuments$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FilesProvider$queryChildDocuments$1(this.$parentDocumentId, this.this$0, this.$projection, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public Object invoke(CoroutineScope coroutineScope, Continuation<? super MatrixCursor> continuation) {
        return new FilesProvider$queryChildDocuments$1(this.$parentDocumentId, this.this$0, this.$projection, continuation).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                this.L$0 = str2;
                this.label = 1;
                Object list = access$getPicker.list(resolve, this);
            ...
            for (Document document : (List) obj) {
                ...
                FilesProvider.access$applyDocument(filesProvider2, newRow, document);
                newRow.add("document_id", str + '/' + document.getId());
            }
            return matrixCursor;
