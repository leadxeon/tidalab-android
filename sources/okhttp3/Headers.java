...
public final class Headers {
    ...
    public static void checkValue(String str, String str2) {
        ...
        throw new NullPointerException(GeneratedOutlineSupport.outline9("value for name ", str2, " == null"));
    }
    ...
    public static final class Builder {
        ...
        public Builder add(String str) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline8("Unexpected header: ", str));
        }
        ...
        public Builder addLenient(String str) {
            ...
            if (str.startsWith(":")) {
                return addLenient(HttpUrl.FRAGMENT_ENCODE_SET, str.substring(1));
            }
            return addLenient(HttpUrl.FRAGMENT_ENCODE_SET, str);
        }
        ...
        public Builder set(String str, Date date) {
            ...
            throw new NullPointerException(GeneratedOutlineSupport.outline9("value for name ", str, " == null"));
        }
