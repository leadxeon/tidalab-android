...
public final class Address {
    ...
    public int hashCode() {
        ...
        int hashCode4 = (this.proxySelector.hashCode() + ((this.connectionSpecs.hashCode() + ((hashCode3 + ((hashCode2 + ((hashCode + ((this.url.hashCode() + 527) * 31)) * 31)) * 31)) * 31)) * 31)) * 31;
    ...
    public String toString() {
        StringBuilder outline13 = GeneratedOutlineSupport.outline13("Address{");
        outline13.append(this.url.host());
        outline13.append(":");
        outline13.append(this.url.port());
        if (this.proxy != null) {
            outline13.append(", proxy=");
            outline13.append(this.proxy);
        } else {
            outline13.append(", proxySelector=");
            outline13.append(this.proxySelector);
        }
        outline13.append("}");
