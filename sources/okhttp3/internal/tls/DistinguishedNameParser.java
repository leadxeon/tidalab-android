...
public final class DistinguishedNameParser {
    ...
    */
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                StringBuilder outline13 = GeneratedOutlineSupport.outline13("Malformed DN: ");
            ...
            if (c2 >= '0' && c2 <= '9') {
                ...
                StringBuilder outline132 = GeneratedOutlineSupport.outline13("Malformed DN: ");
                outline132.append(this.dn);
        ...
        StringBuilder outline133 = GeneratedOutlineSupport.outline13("Malformed DN: ");
        outline133.append(this.dn);
        throw new IllegalStateException(outline133.toString());
    }
    ...
    private char getEscaped() {
        ...
        StringBuilder outline13 = GeneratedOutlineSupport.outline13("Unexpected end of DN: ");
        outline13.append(this.dn);
        throw new IllegalStateException(outline13.toString());
    }
    ...
    private String hexAV() {
        ...
        StringBuilder outline132 = GeneratedOutlineSupport.outline13("Unexpected end of DN: ");
        outline132.append(this.dn);
        throw new IllegalStateException(outline132.toString());
    }
    ...
    public String findMostSpecific(String str) {
        ...
        do {
            ...
            if (c == '\"') {
                ...
                str2 = (c == '+' || c == ',' || c == ';') ? HttpUrl.FRAGMENT_ENCODE_SET : escapedAV();
            } else {
                str2 = hexAV();
            }
