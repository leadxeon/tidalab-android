...
public final class DiskLruCache implements Closeable, Flushable {
            ...
            synchronized (DiskLruCache.this) {
                ...
                if (!(!diskLruCache.initialized) && !diskLruCache.closed) {
                    ...
                    try {
                        ...
                        diskLruCache2.journalWriter = new RealBufferedSink(new Okio.AnonymousClass3());
                    }
                }
            }
        }
    ...
    public final class Entry {
        ...
        private IOException invalidLengths(String[] strArr) throws IOException {
            StringBuilder outline13 = GeneratedOutlineSupport.outline13("unexpected journal line: ");
            outline13.append(Arrays.toString(strArr));
    ...
    private void readJournal() throws IOException {
        Source source = this.fileSystem.source(this.journalFile);
        Logger logger = Okio.logger;
        ...
        try {
            ...
            if (!MAGIC.equals(readUtf8LineStrict) || !VERSION_1.equals(readUtf8LineStrict2) || !Integer.toString(this.appVersion).equals(readUtf8LineStrict3) || !Integer.toString(this.valueCount).equals(readUtf8LineStrict4) || !HttpUrl.FRAGMENT_ENCODE_SET.equals(readUtf8LineStrict5)) {
    ...
    private void readJournalLine(String str) throws IOException {
        ...
        if (indexOf != -1) {
            ...
            if (indexOf2 != -1 && indexOf == 5 && str.startsWith(CLEAN)) {
                ...
                throw new IOException(GeneratedOutlineSupport.outline8("unexpected journal line: ", str));
            }
        } else {
            throw new IOException(GeneratedOutlineSupport.outline8("unexpected journal line: ", str));
        }
    ...
    private void validateKey(String str) {
        if (!LEGAL_KEY_PATTERN.matcher(str).matches()) {
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline9("keys must match regex [a-z0-9_-]{1,120}: \"", str, "\""));
        }
    }
    ...
    public synchronized void rebuildJournal() throws IOException {
        ...
        realBufferedSink.writeUtf8(MAGIC);
        realBufferedSink.writeByte(10);
        realBufferedSink.writeUtf8(VERSION_1);
        realBufferedSink.writeByte(10);
