...
public final class Util {
    ...
    public static String canonicalizeHost(String str) {
        ...
        if (str.contains(":")) {
            ...
            throw new AssertionError(GeneratedOutlineSupport.outline9("Invalid IPv6 address: '", str, "'"));
        }
        try {
    ...
    public static int checkDuration(String str, long j, TimeUnit timeUnit) {
        ...
        if (i >= 0) {
            ...
            if (millis > 2147483647L) {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline8(str, " too large."));
            } else if (millis != 0 || i <= 0) {
                return (int) millis;
            } else {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline8(str, " too small."));
            }
        } else {
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline8(str, " < 0"));
        }
    }
    ...
    */
    private static java.net.InetAddress decodeIpv6(java.lang.String r11, int r12, int r13) {
        ...
        L_0x008b:
            java.net.InetAddress r11 = java.net.InetAddress.getByAddress(r1)     // Catch: UnknownHostException -> 0x0090
            return r11
        L_0x0090:
