...
public final class ClassesInfoCache {
    ...
    public final void verifyAndPutHandler(Map<MethodReference, Lifecycle.Event> map, MethodReference methodReference, Lifecycle.Event event, Class<?> cls) {
        ...
        if (event2 != null && event != event2) {
            ...
            StringBuilder outline13 = GeneratedOutlineSupport.outline13("Method ");
            outline13.append(method.getName());
            outline13.append(" in ");
            outline13.append(cls.getName());
            outline13.append(" already declared with different @OnLifecycleEvent value: previous value ");
            outline13.append(event2);
            outline13.append(", new value ");
            outline13.append(event);
