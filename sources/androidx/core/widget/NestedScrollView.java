...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild {
    ...
    public OverScroller mScroller = new OverScroller(getContext());
    public final NestedScrollingParentHelper mParentHelper = new NestedScrollingParentHelper();
    public final NestedScrollingChildHelper mChildHelper = new NestedScrollingChildHelper(this);
        ...
        public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            ...
            if (i != 4096) {
                if (i == 8192 || i == 16908344) {
                    ...
                    nestedScrollView.smoothScrollBy(0 - nestedScrollView.getScrollX(), max - nestedScrollView.getScrollY(), RNCWebViewManager.SHOULD_OVERRIDE_URL_LOADING_TIMEOUT, true);
                    return true;
                } else if (i != 16908346) {
                    return false;
                }
            ...
            nestedScrollView.smoothScrollBy(0 - nestedScrollView.getScrollX(), min - nestedScrollView.getScrollY(), RNCWebViewManager.SHOULD_OVERRIDE_URL_LOADING_TIMEOUT, true);
            return true;
        }
    }
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            ...
            return GeneratedOutlineSupport.outline10(outline13, this.scrollPosition, "}");
        }
    ...
    public final void doScrollY(int i) {
        ...
        if (this.mSmoothScrollingEnabled) {
            smoothScrollBy(0, i, RNCWebViewManager.SHOULD_OVERRIDE_URL_LOADING_TIMEOUT, false);
        } else {
            scrollBy(0, i);
        }
    }
    ...
    */
    ...
    public boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (view != null && !(true ^ isWithinDeltaOfScreen(view, 0, getHeight()))) {
            ...
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (overScrollByCompat(0, i2, 0, getScrollY(), 0, scrollRange, 0, 0) && !hasNestedScrollingParent(0)) {
                            this.mVelocityTracker.clear();
                        }
                        int scrollY2 = getScrollY() - scrollY;
                        int[] iArr = this.mScrollConsumed;
                        iArr[1] = 0;
                        this.mChildHelper.dispatchNestedScrollInternal(0, scrollY2, 0, i2 - scrollY2, this.mScrollOffset, 0, iArr);
                        ...
                        if (z) {
                            ...
                            int i5 = scrollY + i4;
                            if (i5 < 0) {
                                this.mEdgeGlowTop.onPull(i4 / getHeight(), motionEvent.getX(findPointerIndex) / getWidth());
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                }
                            } else if (i5 > scrollRange) {
                                this.mEdgeGlowBottom.onPull(i4 / getHeight(), 1.0f - (motionEvent.getX(findPointerIndex) / getWidth()));
                                if (!this.mEdgeGlowTop.isFinished()) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean overScrollByCompat(int r13, int r14, int r15, int r16, int r17, int r18, int r19, int r20) {
        /*
            r12 = this;
            r0 = r12
        ...
        L_0x0086:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.NestedScrollView.overScrollByCompat(int, int, int, int, int, int, int, int):boolean");
    }
    ...
    public boolean requestChildRectangleOnScreen(View view, Rect rect, boolean z) {
        ...
        if (z2) {
            if (z) {
                ...
                smoothScrollBy(0, computeScrollDeltaToGetChildRectOnScreen, RNCWebViewManager.SHOULD_OVERRIDE_URL_LOADING_TIMEOUT, false);
            }
        }
        return z2;
    }
