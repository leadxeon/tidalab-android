...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    */
    ...
    public void setTintList(ColorStateList colorStateList) {
        Drawable drawable = this.mDelegateDrawable;
        if (drawable != null) {
            AppOpsManagerCompat.setTintList(drawable, colorStateList);
            return;
        }
        VectorDrawableCompatState vectorDrawableCompatState = this.mVectorState;
    ...
    public static abstract class VPath extends VObject {
        ...
        public void setPathData(PathParser$PathDataNode[] pathParser$PathDataNodeArr) {
            if (!AppOpsManagerCompat.canMorph(this.mNodes, pathParser$PathDataNodeArr)) {
                this.mNodes = AppOpsManagerCompat.deepCopyNodes(pathParser$PathDataNodeArr);
                return;
            }
        ...
        public VPath(VPath vPath) {
            ...
            this.mNodes = AppOpsManagerCompat.deepCopyNodes(vPath.mNodes);
        }
    }
