...
public class AppCompatTextView extends TextView implements TintableCompoundDrawablesView, AutoSizeableTextView {
    ...
    public CharSequence getText() {
        ...
        if (future != null) {
            try {
                ...
                AppOpsManagerCompat.setPrecomputedText(this, future.get());
    ...
    public PrecomputedTextCompat.Params getTextMetricsParamsCompat() {
        return AppOpsManagerCompat.getTextMetricsParams(this);
    }
    ...
    public void setFirstBaselineToTopHeight(int i) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            AppOpsManagerCompat.setFirstBaselineToTopHeight(this, i);
        }
    }
    ...
    public void setLastBaselineToBottomHeight(int i) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            AppOpsManagerCompat.setLastBaselineToBottomHeight(this, i);
        }
    }

    @Override // android.widget.TextView
    public void setLineHeight(int i) {
        AppOpsManagerCompat.setLineHeight(this, i);
    }

    public void setPrecomputedText(PrecomputedTextCompat precomputedTextCompat) {
        AppOpsManagerCompat.setPrecomputedText(this, precomputedTextCompat);
    }
    ...
    public void setTextMetricsParamsCompat(PrecomputedTextCompat.Params params) {
        ...
        setTextDirection(i2);
        if (i < 23) {
            float textScaleX = params.mPaint.getTextScaleX();
        ...
        getPaint().set(params.mPaint);
        setBreakStrategy(params.mBreakStrategy);
        setHyphenationFrequency(params.mHyphenationFrequency);
    }
    ...
    public void setTextSize(int i, float f) {
        ...
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null && !z && !appCompatTextHelper.isAutoSizeEnabled()) {
